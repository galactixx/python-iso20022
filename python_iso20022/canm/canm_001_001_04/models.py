...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:canm.001.001.04"


@dataclass
class AdditionalData1Canm00100104:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:canm.001.001.04",
            "min_length": 1,
            "max_length": 35,
        },
    )
...
@dataclass
class BatchManagementInformation1Canm00100104:
...
@dataclass
class Jurisdiction2Canm00100104:
...
@dataclass
class Reconciliation4Canm00100104:
...
@dataclass
class SupplementaryDataEnvelope1Canm00100104:
...
@dataclass
class AdditionalData2Canm00100104:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
    ...
    dtls: list[AdditionalData1Canm00100104] = field(
...
@dataclass
class AdditionalFee3Canm00100104:
...
@dataclass
class ContentInformationType41Canm00100104:
    macdata: Optional[Macdata1Canm00100104] = field(
        default=None,
        metadata={
            "name": "MACData",
            "type": "Element",
...
@dataclass
class GenericIdentification183Canm00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ProcessingResult26Canm00100104:
    ...
    addtl_inf: list[AdditionalData1Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "AddtlInf",
            "type": "Element",
...
@dataclass
class ProgrammeMode5Canm00100104:
    ...
    addtl_id: list[AdditionalData1Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "AddtlId",
            "type": "Element",
...
@dataclass
class SettlementService6Canm00100104:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class SupplementaryData1Canm00100104:
    ...
    envlp: Optional[SupplementaryDataEnvelope1Canm00100104] = field(
        default=None,
        metadata={
            "name": "Envlp",
            "type": "Element",
...
@dataclass
class Traceability10Canm00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
class Header71Canm00100104:
    ...
    btch_mgmt_inf: Optional[BatchManagementInformation1Canm00100104] = field(
        default=None,
        metadata={
            "name": "BtchMgmtInf",
            "type": "Element",
    ...
    initg_pty: Optional[GenericIdentification183Canm00100104] = field(
        default=None,
        metadata={
            "name": "InitgPty",
            "type": "Element",
    ...
    rcpt_pty: Optional[GenericIdentification183Canm00100104] = field(
        default=None,
        metadata={
            "name": "RcptPty",
            "type": "Element",
    ...
    trac_data: list[AdditionalData1Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "TracData",
            "type": "Element",
    ...
    tracblt: list[Traceability10Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "Tracblt",
            "type": "Element",
...
@dataclass
class NetworkManagementInitiationV04Canm00100104:
    hdr: Optional[Header71Canm00100104] = field(
        default=None,
        metadata={
            "name": "Hdr",
            "type": "Element",
    ...
    ntwk_mgmt_tp: Optional[NetworkManagementType1Code] = field(
        default=None,
        metadata={
            "name": "NtwkMgmtTp",
            "type": "Element",
    ...
    othr_ntwk_mgmt_tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "OthrNtwkMgmtTp",
            "type": "Element",
    ...
    prgrmm: Optional[ProgrammeMode5Canm00100104] = field(
        default=None,
        metadata={
            "name": "Prgrmm",
            "type": "Element",
    ...
    max_nb_of_msgs: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "MaxNbOfMsgs",
            "type": "Element",
    ...
    jursdctn: Optional[Jurisdiction2Canm00100104] = field(
        default=None,
        metadata={
            "name": "Jursdctn",
            "type": "Element",
    ...
    sttlm_svc: Optional[SettlementService6Canm00100104] = field(
        default=None,
        metadata={
            "name": "SttlmSvc",
            "type": "Element",
    ...
    addtl_fee: list[AdditionalFee3Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "AddtlFee",
            "type": "Element",
    ...
    rcncltn: Optional[Reconciliation4Canm00100104] = field(
        default=None,
        metadata={
            "name": "Rcncltn",
            "type": "Element",
    ...
    addtl_data: list[AdditionalData2Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "AddtlData",
            "type": "Element",
    ...
    prcg_rslt: Optional[ProcessingResult26Canm00100104] = field(
        default=None,
        metadata={
            "name": "PrcgRslt",
            "type": "Element",
    ...
    splmtry_data: list[SupplementaryData1Canm00100104] = field(
        default_factory=list,
        metadata={
            "name": "SplmtryData",
            "type": "Element",
    ...
    scty_trlr: Optional[ContentInformationType41Canm00100104] = field(
        default=None,
        metadata={
            "name": "SctyTrlr",
            "type": "Element",
...
class Canm00100104:
    ...
    ntwk_mgmt_initn: Optional[NetworkManagementInitiationV04Canm00100104] = field(
        default=None,
        metadata={
            "name": "NtwkMgmtInitn",
            "type": "Element",
