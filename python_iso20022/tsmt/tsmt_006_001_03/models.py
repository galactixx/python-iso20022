...
@dataclass
class Bicidentification1Tsmt00600103:
    class Meta:
...
@dataclass
class DocumentIdentification3Tsmt00600103:
...
@dataclass
class MessageIdentification1Tsmt00600103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SimpleIdentificationInformationTsmt00600103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class DocumentIdentification5Tsmt00600103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PendingActivity2Tsmt00600103:
...
@dataclass
class TransactionStatus4Tsmt00600103:
...
@dataclass
class AmendmentAcceptanceNotificationV03Tsmt00600103:
