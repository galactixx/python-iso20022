...
@dataclass
class Bicidentification1Tsmt03600103(ISO20022MessageElement):
    class Meta:
...
@dataclass
class DocumentIdentification3Tsmt03600103(ISO20022MessageElement):
...
@dataclass
class MessageIdentification1Tsmt03600103(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SimpleIdentificationInformationTsmt03600103(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class DocumentIdentification5Tsmt03600103(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PendingActivity2Tsmt03600103(ISO20022MessageElement):
...
@dataclass
class TransactionStatus5Tsmt03600103(ISO20022MessageElement):
...
@dataclass
class StatusExtensionRequestNotificationV03Tsmt03600103(ISO20022MessageElement):
...
@dataclass
class Tsmt03600103(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:tsmt.036.001.03"
