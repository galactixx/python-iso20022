...
@dataclass
class Bicidentification1Tsmt02400103:
    class Meta:
...
@dataclass
class DocumentIdentification3Tsmt02400103:
...
@dataclass
class MessageIdentification1Tsmt02400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SimpleIdentificationInformationTsmt02400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class DocumentIdentification5Tsmt02400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PendingActivity2Tsmt02400103:
...
@dataclass
class TransactionStatus4Tsmt02400103:
...
@dataclass
class ActionReminderV03Tsmt02400103:
