...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:tsmt.012.001.05"
...
class AirportName1ChoiceTsmt01200105:
    ...
    othr_airprt_desc: Optional[AirportDescription1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "OthrAirprtDesc",
            "type": "Element",
...
class Charges5Tsmt01200105:
    ...
    amt: Optional[CurrencyAndAmountTsmt01200105] = field(
        default=None,
        metadata={
            "name": "Amt",
            "type": "Element",
...
class CountrySubdivision1ChoiceTsmt01200105:
    ...
    prtry: Optional[GenericIdentification1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Prtry",
            "type": "Element",
...
class DocumentIdentification1Tsmt01200105:
    ...
    submitr: Optional[Bicidentification1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Submitr",
            "type": "Element",
...
class GenericAccountIdentification1Tsmt01200105:
    ...
    schme_nm: Optional[AccountSchemeName1ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "SchmeNm",
            "type": "Element",
...
class Incoterms4ChoiceTsmt01200105:
    ...
    prtry: Optional[GenericIdentification13Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Prtry",
            "type": "Element",
...
class NameAndAddress6Tsmt01200105:
    ...
    adr: Optional[PostalAddress2Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Adr",
            "type": "Element",
...
class PartyIdentification26Tsmt01200105:
    ...
    prtry_id: Optional[GenericIdentification4Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "PrtryId",
            "type": "Element",
    ...
    pstl_adr: Optional[PostalAddress5Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "PstlAdr",
            "type": "Element",
...
class ShipmentSchedule2ChoiceTsmt01200105:
    ...
    shipmnt_sub_schdl: list[ShipmentDateRange2Tsmt01200105] = field(
        default_factory=list,
        metadata={
...
class AccountIdentification4ChoiceTsmt01200105:
    ...
    othr: Optional[GenericAccountIdentification1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Othr",
            "type": "Element",
...
class Adjustment7Tsmt01200105:
    ...
    amt_or_pctg: Optional[AmountOrPercentage2ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "AmtOrPctg",
            "type": "Element",
...
class BankContactPerson1ChoiceTsmt01200105:
    ...
    sellr_bk_ctct_prsn: list[ContactIdentification1Tsmt01200105] = field(
        default_factory=list,
        metadata={
...
class FinancialInstitutionIdentification4ChoiceTsmt01200105:
    ...
    nm_and_adr: Optional[NameAndAddress6Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "NmAndAdr",
            "type": "Element",
...
class Location2Tsmt01200105:
    ...
    ctry_sub_dvsn: Optional[CountrySubdivision1ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "CtrySubDvsn",
            "type": "Element",
...
class ProductCategory1ChoiceTsmt01200105:
    ...
    othr_pdct_ctgy: Optional[GenericIdentification4Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "OthrPdctCtgy",
            "type": "Element",
...
class ProductCharacteristics1ChoiceTsmt01200105:
    ...
    othr_pdct_chrtcs: Optional[GenericIdentification4Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "OthrPdctChrtcs",
            "type": "Element",
...
class ProductIdentifier2ChoiceTsmt01200105:
    ...
    othr_pdct_idr: Optional[GenericIdentification4Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "OthrPdctIdr",
            "type": "Element",
...
class RequiredSubmission3Tsmt01200105:
    ...
    mtch_issr: Optional[PartyIdentification27Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "MtchIssr",
            "type": "Element",
...
class RequiredSubmission4Tsmt01200105:
    ...
    mtch_manfctr: Optional[PartyIdentification27Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "MtchManfctr",
            "type": "Element",
...
class TransportByAir5Tsmt01200105:
    ...
    dstn_airprt: list[AirportName1ChoiceTsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "DstnAirprt",
            "type": "Element",
...
class CashAccount24Tsmt01200105:
    ...
    tp: Optional[CashAccountType2ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "Tp",
            "type": "Element",
...
class Charge24Tsmt01200105:
    ...
    chrgs: list[ChargesDetails3Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "Chrgs",
            "type": "Element",
...
class SingleTransport7Tsmt01200105:
    ...
    trnsprt_by_sea: list[TransportBySea6Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "TrnsprtBySea",
            "type": "Element",
    ...
    trnsprt_by_road: list[TransportByRoad5Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "TrnsprtByRoad",
            "type": "Element",
    ...
    trnsprt_by_rail: list[TransportByRail5Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "TrnsprtByRail",
            "type": "Element",
...
class SettlementTerms3Tsmt01200105:
    ...
    cdtr_acct: Optional[CashAccount24Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "CdtrAcct",
            "type": "Element",
...
class TransportMeans5Tsmt01200105:
    ...
    mltmdl_trnsprt: Optional[MultimodalTransport3Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "MltmdlTrnsprt",
            "type": "Element",
...
class LineItemDetails13Tsmt01200105:
    ...
    qty: Optional[Quantity9Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Qty",
            "type": "Element",
    ...
    qty_tlrnce: Optional[PercentageTolerance1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "QtyTlrnce",
            "type": "Element",
    ...
    unit_pric: Optional[UnitPrice18Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "UnitPric",
            "type": "Element",
    ...
    pric_tlrnce: Optional[PercentageTolerance1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "PricTlrnce",
            "type": "Element",
    ...
    pdct_idr: list[ProductIdentifier2ChoiceTsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "PdctIdr",
            "type": "Element",
    ...
    pdct_chrtcs: list[ProductCharacteristics1ChoiceTsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "PdctChrtcs",
            "type": "Element",
    ...
    pdct_ctgy: list[ProductCategory1ChoiceTsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "PdctCtgy",
            "type": "Element",
    ...
    shipmnt_schdl: Optional[ShipmentSchedule2ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "ShipmntSchdl",
            "type": "Element",
    ...
    rtg_summry: Optional[TransportMeans5Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "RtgSummry",
            "type": "Element",
    ...
    adjstmnt: list[Adjustment7Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "Adjstmnt",
            "type": "Element",
    ...
    frght_chrgs: Optional[Charge24Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "FrghtChrgs",
            "type": "Element",
    ...
    tax: list[Tax23Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "Tax",
            "type": "Element",
    ...
    ttl_amt: Optional[CurrencyAndAmountTsmt01200105] = field(
        default=None,
        metadata={
            "name": "TtlAmt",
            "type": "Element",
    ...
    incotrms: Optional[Incoterms4Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Incotrms",
            "type": "Element",
...
class PaymentObligation2Tsmt01200105:
    ...
    rcpt_bk: Optional[Bicidentification1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "RcptBk",
            "type": "Element",
    ...
    pmt_oblgtn_amt: Optional[AmountOrPercentage2ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "PmtOblgtnAmt",
            "type": "Element",
    ...
    chrgs: list[Charges5Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "Chrgs",
            "type": "Element",
    ...
    aplbl_rules: Optional[BpoapplicableRules1ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "AplblRules",
            "type": "Element",
    ...
    plc_of_jursdctn: Optional[Location2Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "PlcOfJursdctn",
            "type": "Element",
    ...
    pmt_terms: list[PaymentTerms4Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "PmtTerms",
            "type": "Element",
    ...
    sttlm_terms: Optional[SettlementTerms3Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "SttlmTerms",
            "type": "Element",
...
class LineItem13Tsmt01200105:
    ...
    line_itm_dtls: list[LineItemDetails13Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "LineItmDtls",
            "type": "Element",
    ...
    line_itms_ttl_amt: Optional[CurrencyAndAmountTsmt01200105] = field(
        default=None,
        metadata={
            "name": "LineItmsTtlAmt",
            "type": "Element",
    ...
    ttl_net_amt: Optional[CurrencyAndAmountTsmt01200105] = field(
        default=None,
        metadata={
            "name": "TtlNetAmt",
            "type": "Element",
    ...
    buyr_dfnd_inf: list[UserDefinedInformation1Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "BuyrDfndInf",
            "type": "Element",
    ...
    sellr_dfnd_inf: list[UserDefinedInformation1Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "SellrDfndInf",
            "type": "Element",
...
class Baseline5Tsmt01200105:
    ...
    purchs_ordr_ref: Optional[DocumentIdentification7Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "PurchsOrdrRef",
            "type": "Element",
    ...
    buyr: Optional[PartyIdentification26Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Buyr",
            "type": "Element",
    ...
    sellr: Optional[PartyIdentification26Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Sellr",
            "type": "Element",
    ...
    buyr_bk: Optional[Bicidentification1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "BuyrBk",
            "type": "Element",
    ...
    sellr_bk: Optional[Bicidentification1Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "SellrBk",
            "type": "Element",
    ...
    buyr_sd_submitg_bk: list[Bicidentification1Tsmt01200105] = field(
        default_factory=list,
        metadata={
    ...
    sellr_sd_submitg_bk: list[Bicidentification1Tsmt01200105] = field(
        default_factory=list,
        metadata={
    ...
    bll_to: Optional[PartyIdentification26Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "BllTo",
            "type": "Element",
    ...
    ship_to: Optional[PartyIdentification26Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "ShipTo",
            "type": "Element",
    ...
    consgn: Optional[PartyIdentification26Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Consgn",
            "type": "Element",
    ...
    goods: Optional[LineItem13Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Goods",
            "type": "Element",
    ...
    pmt_terms: list[PaymentTerms5Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "PmtTerms",
            "type": "Element",
    ...
    pmt_oblgtn: list[PaymentObligation2Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "PmtOblgtn",
            "type": "Element",
    ...
    comrcl_data_set_reqrd: Optional[RequiredSubmission2Tsmt01200105] = field(
        default=None,
        metadata={
    ...
    trnsprt_data_set_reqrd: Optional[RequiredSubmission2Tsmt01200105] = field(
        default=None,
        metadata={
    ...
    insrnc_data_set_reqrd: Optional[RequiredSubmission3Tsmt01200105] = field(
        default=None,
        metadata={
    ...
    cert_data_set_reqrd: list[RequiredSubmission4Tsmt01200105] = field(
        default_factory=list,
        metadata={
    ...
    othr_cert_data_set_reqrd: list[RequiredSubmission6Tsmt01200105] = field(
        default_factory=list,
        metadata={
...
class BaselineReSubmissionV05Tsmt01200105:
    ...
    tx_id: Optional[SimpleIdentificationInformationTsmt01200105] = field(
        default=None,
        metadata={
            "name": "TxId",
            "type": "Element",
    ...
    submitr_tx_ref: Optional[SimpleIdentificationInformationTsmt01200105] = field(
        default=None,
        metadata={
            "name": "SubmitrTxRef",
            "type": "Element",
    ...
    baseln: Optional[Baseline5Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "Baseln",
            "type": "Element",
    ...
    buyr_ctct_prsn: list[ContactIdentification1Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "BuyrCtctPrsn",
            "type": "Element",
    ...
    sellr_ctct_prsn: list[ContactIdentification1Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "SellrCtctPrsn",
            "type": "Element",
    ...
    bk_ctct_prsn: Optional[BankContactPerson1ChoiceTsmt01200105] = field(
        default=None,
        metadata={
            "name": "BkCtctPrsn",
            "type": "Element",
    ...
    othr_bk_ctct_prsn: list[ContactIdentification3Tsmt01200105] = field(
        default_factory=list,
        metadata={
            "name": "OthrBkCtctPrsn",
            "type": "Element",
...
class Tsmt01200105:
    ...
    baseln_re_submissn: Optional[BaselineReSubmissionV05Tsmt01200105] = field(
        default=None,
        metadata={
            "name": "BaselnReSubmissn",
            "type": "Element",
            "required": True,
        },
    )
