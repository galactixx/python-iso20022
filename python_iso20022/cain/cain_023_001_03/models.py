...
@dataclass
class AccountDetails4Cain02300103:
...
@dataclass
class AdditionalData1Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalRiskData1Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class BatchManagementInformation1Cain02300103:
...
@dataclass
class CardholderName2Cain02300103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class CardholderName3Cain02300103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class ContactPersonal1Cain02300103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class EcommerceData1Cain02300103:
    class Meta:
        name = "ECommerceData1"
...
@dataclass
class EncryptedData2ChoiceCain02300103:
...
@dataclass
class Jurisdiction2Cain02300103:
...
@dataclass
class Kekidentifier2Cain02300103:
    class Meta:
        name = "KEKIdentifier2"
...
@dataclass
class Kekidentifier6Cain02300103:
    class Meta:
        name = "KEKIdentifier6"
...
@dataclass
class LocalAddress1Cain02300103:
    adr_line1: Optional[str] = field(
        default=None,
        metadata={
            "name": "AdrLine1",
...
@dataclass
class Reconciliation4Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SupplementaryDataEnvelope1Cain02300103:
...
@dataclass
class Track2Data1ChoiceCain02300103:
...
@dataclass
class VerificationValue1Cain02300103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class AdditionalAmounts4Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalData2Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalFee3Cain02300103:
...
@dataclass
class AdditionalService2Cain02300103:
...
@dataclass
class AlgorithmIdentification26Cain02300103:
...
@dataclass
class CardReadingCapabilities1Cain02300103:
...
@dataclass
class CardWritingCapabilities1Cain02300103:
...
@dataclass
class CardholderVerificationCapabilities1Cain02300103:
...
@dataclass
class ContentInformationType41Cain02300103:
...
@dataclass
class Credentials3Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class DetailedAmount22Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class DeviceIdentification1Cain02300103:
...
@dataclass
class DisplayCapabilities6Cain02300103:
...
@dataclass
class EncryptedDataElement2Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ExchangeRateInformation5Cain02300103:
...
@dataclass
class GenericIdentification183Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class OriginalTransactionIdentification1Cain02300103:
...
@dataclass
class PointOfInteractionComponent16Cain02300103:
...
@dataclass
class ProgrammeMode4Cain02300103:
...
@dataclass
class RecommendationAction1Cain02300103:
...
@dataclass
class RelativeDistinguishedName1Cain02300103:
...
@dataclass
class RiskInputData2Cain02300103:
...
@dataclass
class SettlementService5Cain02300103:
...
@dataclass
class SupplementaryData1Cain02300103:
...
@dataclass
class Traceability10Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class TransactionCharacteristics2Cain02300103:
...
@dataclass
class TransactionIdentification57Cain02300103:
    lcl_dt: Optional[XmlDate] = field(
        default=None,
        metadata={
            "name": "LclDt",
...
@dataclass
class Verification6Cain02300103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AlgorithmIdentification25Cain02300103:
...
@dataclass
class AlgorithmIdentification28Cain02300103:
...
@dataclass
class Cardholder22Cain02300103:
...
@dataclass
class CertificateIssuer1Cain02300103:
...
@dataclass
class CustomerDevice5Cain02300103:
...
@dataclass
class EncryptedData2Cain02300103:
    ctrl: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctrl",
...
@dataclass
class OriginalDataElements4Cain02300103:
...
@dataclass
class PartyIdentification285Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification286Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ProcessingResult27Cain02300103:
...
@dataclass
class RiskAssessment3Cain02300103:
...
@dataclass
class SponsoredMerchant3Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class StrongCustomerAuthentication2Cain02300103:
...
@dataclass
class TransactionAmounts4Cain02300103:
...
@dataclass
class AlgorithmIdentification27Cain02300103:
...
@dataclass
class EncryptedContent8Cain02300103:
...
@dataclass
class IssuerAndSerialNumber1Cain02300103:
...
@dataclass
class PartyIdentification288Cain02300103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class RiskContext3Cain02300103:
...
@dataclass
class Recipient5ChoiceCain02300103:
...
@dataclass
class KeyTransport6Cain02300103:
    vrsn: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "Vrsn",
...
@dataclass
class Recipient7ChoiceCain02300103:
...
@dataclass
class EnvelopedData12Cain02300103:
    vrsn: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "Vrsn",
...
@dataclass
class ProtectedData2Cain02300103:
...
@dataclass
class CardManagementInitiationV03Cain02300103:
