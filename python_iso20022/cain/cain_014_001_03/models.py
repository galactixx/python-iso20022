...
@dataclass
class AccountDetails4Cain01400103:
...
@dataclass
class AdditionalData1Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalRiskData1Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class BatchManagementInformation1Cain01400103:
...
@dataclass
class CardholderName2Cain01400103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class CardholderName3Cain01400103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class ContactBusiness1Cain01400103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class ContactPersonal1Cain01400103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class DisputeIdentification1Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class EcommerceData1Cain01400103:
    class Meta:
        name = "ECommerceData1"
...
@dataclass
class EncryptedData2ChoiceCain01400103:
...
@dataclass
class Jurisdiction2Cain01400103:
...
@dataclass
class Kekidentifier2Cain01400103:
    class Meta:
        name = "KEKIdentifier2"
...
@dataclass
class Kekidentifier6Cain01400103:
    class Meta:
        name = "KEKIdentifier6"
...
@dataclass
class LocalAddress1Cain01400103:
    adr_line1: Optional[str] = field(
        default=None,
        metadata={
            "name": "AdrLine1",
...
@dataclass
class Reconciliation4Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SpecialProgrammeDetails2Cain01400103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class SupplementaryDataEnvelope1Cain01400103:
...
@dataclass
class Track2Data1ChoiceCain01400103:
...
@dataclass
class AdditionalAmounts4Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalData2Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalFee3Cain01400103:
...
@dataclass
class AdditionalService2Cain01400103:
...
@dataclass
class AlgorithmIdentification26Cain01400103:
...
@dataclass
class CardReadingCapabilities1Cain01400103:
...
@dataclass
class CardWritingCapabilities1Cain01400103:
...
@dataclass
class CardholderVerificationCapabilities1Cain01400103:
...
@dataclass
class ContentInformationType41Cain01400103:
...
@dataclass
class Credentials3Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class DepositDetails3Cain01400103:
...
@dataclass
class DetailedAmount22Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class DeviceIdentification1Cain01400103:
...
@dataclass
class DisplayCapabilities6Cain01400103:
...
@dataclass
class DisputeDocumentation1Cain01400103:
    frmt: Optional[OutputFormat4Code] = field(
        default=None,
        metadata={
            "name": "Frmt",
...
@dataclass
class DisputeReference1Cain01400103:
...
@dataclass
class EncryptedDataElement2Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ErrorDetails3Cain01400103:
...
@dataclass
class ExchangeRateInformation5Cain01400103:
...
@dataclass
class FundingSource4Cain01400103:
...
@dataclass
class GenericIdentification183Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class OriginalTransactionCharacteristics1Cain01400103:
...
@dataclass
class PointOfInteractionComponent16Cain01400103:
...
@dataclass
class ProcessingResult25Cain01400103:
...
@dataclass
class ProgrammeMode4Cain01400103:
...
@dataclass
class ProgrammeMode5Cain01400103:
    apld_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "ApldId",
...
@dataclass
class RecommendationAction1Cain01400103:
...
@dataclass
class RelativeDistinguishedName1Cain01400103:
...
@dataclass
class RetrievalFulfilmentInstructions3Cain01400103:
...
@dataclass
class RiskInputData2Cain01400103:
...
@dataclass
class SettlementService6Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class SpecialProgrammeQualification2Cain01400103:
...
@dataclass
class SupplementaryData1Cain01400103:
...
@dataclass
class Traceability10Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class TransactionCharacteristics3Cain01400103:
    tx_tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "TxTp",
...
@dataclass
class TransactionIdentification54Cain01400103:
...
@dataclass
class Verification7Cain01400103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AlgorithmIdentification25Cain01400103:
...
@dataclass
class AlgorithmIdentification28Cain01400103:
...
@dataclass
class Cardholder22Cain01400103:
...
@dataclass
class CertificateIssuer1Cain01400103:
...
@dataclass
class CustomerDevice5Cain01400103:
...
@dataclass
class DisputeData4Cain01400103:
...
@dataclass
class EncryptedData2Cain01400103:
    ctrl: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctrl",
...
@dataclass
class FinancialInstitution8Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class FundingService3Cain01400103:
    prvdr: Optional[str] = field(
        default=None,
        metadata={
            "name": "Prvdr",
...
@dataclass
class PartyIdentification284Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification285Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification286Cain01400103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ProcessingResult22Cain01400103:
    rspn_src_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "RspnSrcId",
...
@dataclass
class RiskAssessment3Cain01400103:
...
@dataclass
class TransactionAmounts3Cain01400103:
...
@dataclass
class AlgorithmIdentification27Cain01400103:
...
@dataclass
class EncryptedContent8Cain01400103:
...
@dataclass
class IssuerAndSerialNumber1Cain01400103:
...
@dataclass
class PartyIdentification287Cain01400103:
...
@dataclass
class RiskContext3Cain01400103:
...
@dataclass
class OriginalTransaction3Cain01400103:
...
@dataclass
class Recipient5ChoiceCain01400103:
...
@dataclass
class KeyTransport6Cain01400103:
    vrsn: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "Vrsn",
...
@dataclass
class Recipient7ChoiceCain01400103:
...
@dataclass
class EnvelopedData12Cain01400103:
    vrsn: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "Vrsn",
...
@dataclass
class ProtectedData2Cain01400103:
...
@dataclass
class RetrievalFulfilmentInitiationV03Cain01400103:
