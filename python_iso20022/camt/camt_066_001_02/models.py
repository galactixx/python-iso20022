...
@dataclass
class AccountSchemeName1ChoiceCamt06600102:
...
@dataclass
class ActiveCurrencyAndAmountCamt06600102:
...
@dataclass
class CashAccountType2ChoiceCamt06600102:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ClearingSystemIdentification2ChoiceCamt06600102:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class DateAndDateTime2ChoiceCamt06600102:
...
@dataclass
class FinancialIdentificationSchemeName1ChoiceCamt06600102:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class FinancialInstrumentQuantity1ChoiceCamt06600102:
...
@dataclass
class GenericIdentification30Camt06600102:
...
@dataclass
class GenericIdentification36Camt06600102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification37Camt06600102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ProxyAccountType1ChoiceCamt06600102:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class References34ChoiceCamt06600102:
...
@dataclass
class SupplementaryDataEnvelope1Camt06600102:
...
@dataclass
class TotalNumber1Camt06600102:
...
@dataclass
class AddressType3ChoiceCamt06600102:
...
@dataclass
class Amount2ChoiceCamt06600102:
...
@dataclass
class AmountAndDirection5Camt06600102:
...
@dataclass
class CashBalanceType3ChoiceCamt06600102:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ClearingSystemMemberIdentification2Camt06600102:
...
@dataclass
class DocumentNumber5ChoiceCamt06600102:
...
@dataclass
class GenericAccountIdentification1Camt06600102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericFinancialIdentification1Camt06600102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class NumberCount1ChoiceCamt06600102:
    cur_instr_nb: Optional[str] = field(
        default=None,
        metadata={
            "name": "CurInstrNb",
...
@dataclass
class PartyIdentification127ChoiceCamt06600102:
...
@dataclass
class PostalAddress1Camt06600102:
...
@dataclass
class PriorityNumeric4ChoiceCamt06600102:
...
@dataclass
class ProcessingPosition7ChoiceCamt06600102:
...
@dataclass
class ProxyAccountIdentification1Camt06600102:
...
@dataclass
class SupplementaryData1Camt06600102:
...
@dataclass
class AccountIdentification4ChoiceCamt06600102:
...
@dataclass
class AmountAndQuantityBreakdown1Camt06600102:
...
@dataclass
class NameAndAddress5Camt06600102:
...
@dataclass
class PostalAddress27Camt06600102:
...
@dataclass
class CashAccount40Camt06600102:
...
@dataclass
class CashSubBalanceTypeAndQuantityBreakdown3Camt06600102:
...
@dataclass
class FinancialInstitutionIdentification23Camt06600102:
...
@dataclass
class PartyIdentification120ChoiceCamt06600102:
    any_bic: Optional[str] = field(
        default=None,
        metadata={
            "name": "AnyBIC",
...
@dataclass
class BranchAndFinancialInstitutionIdentification8Camt06600102:
...
@dataclass
class IntraBalance5Camt06600102:
...
@dataclass
class PartyIdentification136Camt06600102:
...
@dataclass
class SystemPartyIdentification8Camt06600102:
...
@dataclass
class TransactionAndDocumentIdentification6Camt06600102:
...
@dataclass
class IntraBalanceMovementInstructionV02Camt06600102:
