...
@dataclass
class AccountSchemeName1ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class ActiveCurrencyAndAmountCamt01100108(ISO20022MessageElement):
...
@dataclass
class ClearingSystemIdentification2ChoiceCamt01100108(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class DateAndDateTime2ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class FinancialIdentificationSchemeName1ChoiceCamt01100108(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class GenericIdentification30Camt01100108(ISO20022MessageElement):
...
@dataclass
class MarketInfrastructureIdentification1ChoiceCamt01100108(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class MessageHeader1Camt01100108(ISO20022MessageElement):
...
@dataclass
class SupplementaryDataEnvelope1Camt01100108(ISO20022MessageElement):
...
@dataclass
class AddressType3ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class Amount2ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class ClearingSystemMemberIdentification2Camt01100108(ISO20022MessageElement):
...
@dataclass
class GenericAccountIdentification1Camt01100108(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericFinancialIdentification1Camt01100108(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class LimitType1ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class SupplementaryData1Camt01100108(ISO20022MessageElement):
...
@dataclass
class SystemIdentification2ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class AccountIdentification4ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class Amount4ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class Limit10Camt01100108(ISO20022MessageElement):
...
@dataclass
class Limit8Camt01100108(ISO20022MessageElement):
...
@dataclass
class PostalAddress27Camt01100108(ISO20022MessageElement):
...
@dataclass
class BranchData5Camt01100108(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class FinancialInstitutionIdentification23Camt01100108(ISO20022MessageElement):
...
@dataclass
class BranchAndFinancialInstitutionIdentification8Camt01100108(ISO20022MessageElement):
...
@dataclass
class LimitIdentification8Camt01100108(ISO20022MessageElement):
...
@dataclass
class LimitIdentification9Camt01100108(ISO20022MessageElement):
    sys_id: Optional[SystemIdentification2ChoiceCamt01100108] = field(
        default=None,
        metadata={
            "name": "SysId",
...
@dataclass
class LimitIdentification3ChoiceCamt01100108(ISO20022MessageElement):
...
@dataclass
class LimitStructure5Camt01100108(ISO20022MessageElement):
...
@dataclass
class ModifyLimitV08Camt01100108(ISO20022MessageElement):
...
@dataclass
class Camt01100108(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:camt.011.001.08"
