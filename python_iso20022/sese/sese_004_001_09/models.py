...
class NameAndAddress5Sese00400109(ISO20022MessageElement):
    ...
    adr: Optional[PostalAddress1Sese00400109] = field(
        default=None,
        metadata={
            "name": "Adr",
            "type": "Element",
...
class PartyIdentification125ChoiceSese00400109(ISO20022MessageElement):
    ...
    prtry_id: Optional[GenericIdentification1Sese00400109] = field(
        default=None,
        metadata={
            "name": "PrtryId",
            "type": "Element",
    ...
    nm_and_adr: Optional[NameAndAddress5Sese00400109] = field(
        default=None,
        metadata={
            "name": "NmAndAdr",
            "type": "Element",
...
class AdditionalReference10Sese00400109(ISO20022MessageElement):
    ...
    ref_issr: Optional[PartyIdentification139Sese00400109] = field(
        default=None,
        metadata={
            "name": "RefIssr",
            "type": "Element",
...
class TransferReference16Sese00400109(ISO20022MessageElement):
    ...
    clnt_ref: Optional[AdditionalReference10Sese00400109] = field(
        default=None,
        metadata={
            "name": "ClntRef",
            "type": "Element",
    ...
    ctr_pty_ref: Optional[AdditionalReference10Sese00400109] = field(
        default=None,
        metadata={
            "name": "CtrPtyRef",
            "type": "Element",
...
class ReversalOfTransferOutConfirmationV09Sese00400109(ISO20022MessageElement):
    ...
    pool_ref: Optional[AdditionalReference11Sese00400109] = field(
        default=None,
        metadata={
            "name": "PoolRef",
            "type": "Element",
    ...
    prvs_ref: Optional[AdditionalReference10Sese00400109] = field(
        default=None,
        metadata={
            "name": "PrvsRef",
            "type": "Element",
    ...
    rltd_ref: Optional[AdditionalReference10Sese00400109] = field(
        default=None,
        metadata={
            "name": "RltdRef",
            "type": "Element",
    ...
    rvsl_refs: list[TransferReference16Sese00400109] = field(
        default_factory=list,
        metadata={
            "name": "RvslRefs",
            "type": "Element",
    ...
    mkt_prctc_vrsn: Optional[MarketPracticeVersion1Sese00400109] = field(
        default=None,
        metadata={
            "name": "MktPrctcVrsn",
            "type": "Element",
    ...
    cpy_dtls: Optional[CopyInformation5Sese00400109] = field(
        default=None,
        metadata={
            "name": "CpyDtls",
            "type": "Element",
...
class Sese00400109(ISO20022Message):
    ...
    rvsl_of_trf_out_conf: Optional[ReversalOfTransferOutConfirmationV09Sese00400109] = (
        field(
            default=None,
            metadata={
                "name": "RvslOfTrfOutConf",
                "type": "Element",
                "required": True,
            },
        )
