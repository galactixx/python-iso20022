...
@dataclass
class AdditionalData1Cafc00100103:
...
@dataclass
class BatchManagementInformation1Cafc00100103:
...
@dataclass
class EncryptedData2ChoiceCafc00100103:
...
@dataclass
class FeeCollectionIdentification1Cafc00100103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class Jurisdiction2Cafc00100103:
...
@dataclass
class Kekidentifier2Cafc00100103:
    class Meta:
        name = "KEKIdentifier2"
...
@dataclass
class Kekidentifier6Cafc00100103:
    class Meta:
        name = "KEKIdentifier6"
...
@dataclass
class Reconciliation4Cafc00100103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SpecialProgrammeDetails2Cafc00100103:
...
@dataclass
class SupplementaryDataEnvelope1Cafc00100103:
...
@dataclass
class AdditionalAmounts4Cafc00100103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalData2Cafc00100103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class AdditionalFee3Cafc00100103:
...
@dataclass
class AlgorithmIdentification26Cafc00100103:
...
@dataclass
class ContentInformationType41Cafc00100103:
...
@dataclass
class DetailedAmount22Cafc00100103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class EncryptedDataElement2Cafc00100103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class FeeCollectionReference2Cafc00100103:
...
@dataclass
class GenericIdentification183Cafc00100103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class OriginalTransactionAmounts3Cafc00100103:
...
@dataclass
class OriginalTransactionIdentification1Cafc00100103:
...
@dataclass
class ProcessingResult26Cafc00100103:
...
@dataclass
class ProgrammeMode5Cafc00100103:
...
@dataclass
class RelativeDistinguishedName1Cafc00100103:
...
@dataclass
class SettlementService6Cafc00100103:
    tp: Optional[str] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class SpecialProgrammeQualification2Cafc00100103:
...
@dataclass
class SupplementaryData1Cafc00100103:
...
@dataclass
class Traceability10Cafc00100103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class TransactionCharacteristics4Cafc00100103:
...
@dataclass
class TransactionIdentification57Cafc00100103:
    lcl_dt: Optional[XmlDate] = field(
        default=None,
        metadata={
            "name": "LclDt",
...
@dataclass
class AlgorithmIdentification25Cafc00100103:
...
@dataclass
class AlgorithmIdentification28Cafc00100103:
...
@dataclass
class CertificateIssuer1Cafc00100103:
...
@dataclass
class EncryptedData2Cafc00100103:
    ctrl: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctrl",
...
@dataclass
class OriginalDataElements3Cafc00100103:
...
@dataclass
class PartyIdentification285Cafc00100103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification286Cafc00100103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class TransactionAmounts3Cafc00100103:
    amt_qlfr: Optional[TypeOfAmount22Code] = field(
        default=None,
        metadata={
            "name": "AmtQlfr",
...
@dataclass
class AlgorithmIdentification27Cafc00100103:
...
@dataclass
class EncryptedContent8Cafc00100103:
...
@dataclass
class IssuerAndSerialNumber1Cafc00100103:
...
@dataclass
class Recipient5ChoiceCafc00100103:
...
@dataclass
class KeyTransport6Cafc00100103:
    vrsn: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "Vrsn",
...
@dataclass
class Recipient7ChoiceCafc00100103:
...
@dataclass
class EnvelopedData12Cafc00100103:
    vrsn: Optional[Decimal] = field(
        default=None,
        metadata={
            "name": "Vrsn",
...
@dataclass
class ProtectedData2Cafc00100103:
...
@dataclass
class FeeCollectionInitiationV03Cafc00100103:
