...
class CorporateActionEventType103ChoiceSeev03200208(ISO20022MessageElement):
    ...
    prtry: Optional[GenericIdentification47Seev03200208] = field(
        default=None,
        metadata={
            "name": "Prtry",
            "type": "Element",
...
class DocumentNumber6ChoiceSeev03200208(ISO20022MessageElement):
    ...
    prtry_nb: Optional[GenericIdentification86Seev03200208] = field(
        default=None,
        metadata={
            "name": "PrtryNb",
            "type": "Element",
...
class SupplementaryData1Seev03200208(ISO20022MessageElement):
    ...
    envlp: Optional[SupplementaryDataEnvelope1Seev03200208] = field(
        default=None,
        metadata={
            "name": "Envlp",
            "type": "Element",
...
class CorporateActionGeneralInformation158Seev03200208(ISO20022MessageElement):
    ...
    evt_tp: Optional[CorporateActionEventType103ChoiceSeev03200208] = field(
        default=None,
        metadata={
            "name": "EvtTp",
            "type": "Element",
...
class DocumentIdentification34Seev03200208(ISO20022MessageElement):
    ...
    doc_nb: Optional[DocumentNumber6ChoiceSeev03200208] = field(
        default=None,
        metadata={
            "name": "DocNb",
            "type": "Element",
...
class ProprietaryStatusAndReason7Seev03200208(ISO20022MessageElement):
    ...
    prtry_rsn: list[ProprietaryReason5Seev03200208] = field(
        default_factory=list,
        metadata={
            "name": "PrtryRsn",
            "type": "Element",
...
class PendingStatus59ChoiceSeev03200208(ISO20022MessageElement):
    ...
    rsn: list[PendingStatusReason19Seev03200208] = field(
        default_factory=list,
        metadata={
            "name": "Rsn",
            "type": "Element",
...
class EventProcessingStatus6ChoiceSeev03200208(ISO20022MessageElement):
    ...
    rcncld: Optional[NoSpecifiedReason1Seev03200208] = field(
        default=None,
        metadata={
            "name": "Rcncld",
            "type": "Element",
    ...
    pdg: Optional[PendingStatus59ChoiceSeev03200208] = field(
        default=None,
        metadata={
            "name": "Pdg",
            "type": "Element",
    ...
    prtry_sts: Optional[ProprietaryStatusAndReason7Seev03200208] = field(
        default=None,
        metadata={
            "name": "PrtrySts",
            "type": "Element",
...
class CorporateActionEventProcessingStatusAdvice002V08Seev03200208(
    ...
    othr_doc_id: list[DocumentIdentification34Seev03200208] = field(
        default_factory=list,
        metadata={
            "name": "OthrDocId",
            "type": "Element",
    ...
    corp_actn_gnl_inf: Optional[CorporateActionGeneralInformation158Seev03200208] = (
        field(
            default=None,
            metadata={
                "name": "CorpActnGnlInf",
    ...
    evt_prcg_sts: list[EventProcessingStatus6ChoiceSeev03200208] = field(
        default_factory=list,
        metadata={
            "name": "EvtPrcgSts",
            "type": "Element",
    ...
    addtl_inf: Optional[CorporateActionNarrative19Seev03200208] = field(
        default=None,
        metadata={
            "name": "AddtlInf",
            "type": "Element",
    ...
    splmtry_data: list[SupplementaryData1Seev03200208] = field(
        default_factory=list,
        metadata={
            "name": "SplmtryData",
            "type": "Element",
...
class Seev03200208(ISO20022Message):
    ...
    corp_actn_evt_prcg_sts_advc: Optional[
        CorporateActionEventProcessingStatusAdvice002V08Seev03200208
    ] = field(
        default=None,
        metadata={
