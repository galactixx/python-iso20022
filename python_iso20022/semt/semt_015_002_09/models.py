...
@dataclass
class ActiveCurrencyAndAmountSemt01500209(ISO20022MessageElement):
...
@dataclass
class DateAndDateTime2ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class FinancialInstrumentQuantity36ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class GenericIdentification18Semt01500209(ISO20022MessageElement):
...
@dataclass
class GenericIdentification39Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification47Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification84Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification86Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class IdentificationSource3ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class IdentificationSource4ChoiceSemt01500209(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class MarketIdentification4ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class SupplementaryDataEnvelope1Semt01500209(ISO20022MessageElement):
...
@dataclass
class AdditionalParameters34Semt01500209(ISO20022MessageElement):
...
@dataclass
class BlockChainAddressWallet7Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ClassificationType33ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class CorporateActionEventType101ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class ForeignExchangeTerms23Semt01500209(ISO20022MessageElement):
...
@dataclass
class FormOfSecurity7ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class Frequency27ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class GenericIdentification85Semt01500209(ISO20022MessageElement):
    tp: Optional[GenericIdentification47Semt01500209] = field(
        default=None,
        metadata={
            "name": "Tp",
...
@dataclass
class InterestComputationMethodFormat5ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class Number23ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class OptionStyle9ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class OptionType7ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class OtherIdentification2Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class OtherIdentification3Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification136ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class PriceRateOrAmount1ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class QuantityBreakdown64Semt01500209(ISO20022MessageElement):
...
@dataclass
class QuantityBreakdown65Semt01500209(ISO20022MessageElement):
    lot_nb: Optional[GenericIdentification39Semt01500209] = field(
        default=None,
        metadata={
            "name": "LotNb",
...
@dataclass
class SafekeepingPlaceTypeAndIdentification1Semt01500209(ISO20022MessageElement):
...
@dataclass
class SafekeepingPlaceTypeAndText15Semt01500209(ISO20022MessageElement):
...
@dataclass
class SecuritiesAccount30Semt01500209(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SecuritiesBalanceType8ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class SecuritiesPaymentStatus6ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class SupplementaryData1Semt01500209(ISO20022MessageElement):
...
@dataclass
class YieldedOrValueType1ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class AmountAndDirection55Semt01500209(ISO20022MessageElement):
...
@dataclass
class Price3Semt01500209(ISO20022MessageElement):
...
@dataclass
class SafekeepingPlaceFormat39ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class SecuritiesSubBalanceTypeAndQuantityBreakdown6Semt01500209(ISO20022MessageElement):
...
@dataclass
class SecurityIdentification20Semt01500209(ISO20022MessageElement):
...
@dataclass
class SecurityIdentification32Semt01500209(ISO20022MessageElement):
    isin: Optional[str] = field(
        default=None,
        metadata={
            "name": "ISIN",
...
@dataclass
class IntraPositionDetails61Semt01500209(ISO20022MessageElement):
...
@dataclass
class PriceType5ChoiceSemt01500209(ISO20022MessageElement):
...
@dataclass
class FinancialInstrumentAttributes119Semt01500209(ISO20022MessageElement):
...
@dataclass
class IntraPositionMovementConfirmation002V09Semt01500209(ISO20022MessageElement):
...
@dataclass
class Semt01500209(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:semt.015.002.09"
