...
@dataclass
class ActiveCurrencyAndAmountSemt00200102:
...
@dataclass
class ActiveOrHistoricCurrencyAnd13DecimalAmountSemt00200102:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class ActiveOrHistoricCurrencyAndAmountSemt00200102:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class AlternateSecurityIdentification1Semt00200102:
...
@dataclass
class DateAndDateTimeChoiceSemt00200102:
...
@dataclass
class FinancialInstrumentQuantityChoiceSemt00200102:
...
@dataclass
class GenericIdentification1Semt00200102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification5Semt00200102:
    issr: Optional[str] = field(
        default=None,
        metadata={
            "name": "Issr",
...
@dataclass
class GenericIdentification6Semt00200102:
    issr: Optional[str] = field(
        default=None,
        metadata={
            "name": "Issr",
...
@dataclass
class GenericIdentification7Semt00200102:
    issr: Optional[str] = field(
        default=None,
        metadata={
            "name": "Issr",
...
@dataclass
class MessageIdentification1Semt00200102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification3Semt00200102:
...
@dataclass
class SimpleIdentificationInformationSemt00200102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class StructuredLongPostalAddress1Semt00200102:
...
@dataclass
class AccountIdentification1Semt00200102:
...
@dataclass
class BalanceQuantity1ChoiceSemt00200102:
...
@dataclass
class FrequencyCodeAndDsscode1ChoiceSemt00200102:
    class Meta:
...
@dataclass
class LongPostalAddress1ChoiceSemt00200102:
...
@dataclass
class PostalAddress1Semt00200102:
...
@dataclass
class PriceRateOrAmountOrUnknownChoiceSemt00200102:
...
@dataclass
class QuantityAndAvailabilitySemt00200102:
    qty: Optional[FinancialInstrumentQuantityChoiceSemt00200102] = field(
        default=None,
        metadata={
            "name": "Qty",
...
@dataclass
class SafekeepingPlaceAsCodeAndPartyIdentificationSemt00200102:
...
@dataclass
class SecurityIdentification3ChoiceSemt00200102:
...
@dataclass
class StatementBasisCodeAndDsscodeChoiceSemt00200102:
    class Meta:
...
@dataclass
class StatementUpdateTypeCodeAndDsscodeChoiceSemt00200102:
    class Meta:
...
@dataclass
class TotalValueInPageAndStatementSemt00200102:
...
@dataclass
class AccountIdentification3Semt00200102:
...
@dataclass
class AccountIdentificationAndPurposeSemt00200102:
    id: Optional[AccountIdentification1Semt00200102] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class FinancialInstrument13Semt00200102:
...
@dataclass
class NameAndAddress2Semt00200102:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class NameAndAddress5Semt00200102:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PriceSourceFormatChoiceSemt00200102:
...
@dataclass
class SafekeepingPlaceFormatChoiceSemt00200102:
...
@dataclass
class SubBalanceQuantity1ChoiceSemt00200102:
    qty: Optional[FinancialInstrumentQuantityChoiceSemt00200102] = field(
        default=None,
        metadata={
            "name": "Qty",
...
@dataclass
class AccountIdentificationFormatChoiceSemt00200102:
...
@dataclass
class AdditionalBalanceInformation2Semt00200102:
...
@dataclass
class PartyIdentification1ChoiceSemt00200102:
    bicor_bei: Optional[str] = field(
        default=None,
        metadata={
            "name": "BICOrBEI",
...
@dataclass
class PartyIdentification2ChoiceSemt00200102:
    bicor_bei: Optional[str] = field(
        default=None,
        metadata={
            "name": "BICOrBEI",
...
@dataclass
class PriceInformation2Semt00200102:
...
@dataclass
class AdditionalReference2Semt00200102:
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class ForeignExchangeTerms6Semt00200102:
...
@dataclass
class SubBalanceInformation2Semt00200102:
    qty: Optional[SubBalanceQuantity1ChoiceSemt00200102] = field(
        default=None,
        metadata={
            "name": "Qty",
...
@dataclass
class AggregateBalancePerSafekeepingPlace3Semt00200102:
...
@dataclass
class Intermediary11Semt00200102:
...
@dataclass
class AggregateBalanceInformation4Semt00200102:
    aggt_qty: Optional[BalanceQuantity1ChoiceSemt00200102] = field(
        default=None,
        metadata={
            "name": "AggtQty",
...
@dataclass
class SafekeepingAccount2Semt00200102:
...
@dataclass
class SubAccountIdentification5Semt00200102:
    id: Optional[AccountIdentificationFormatChoiceSemt00200102] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class CustodyStatementOfHoldingsV02Semt00200102:
