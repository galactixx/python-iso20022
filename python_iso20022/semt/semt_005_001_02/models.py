...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:semt.005.001.02"
...
class BalanceQuantity1ChoiceSemt00500102(ISO20022MessageElement):
    ...
    qty_as_dss: Optional[GenericIdentification6Semt00500102] = field(
        default=None,
        metadata={
            "name": "QtyAsDSS",
            "type": "Element",
...
class FrequencyCodeAndDsscode1ChoiceSemt00500102(ISO20022MessageElement):
    ...
    frqcy_as_dss: Optional[GenericIdentification7Semt00500102] = field(
        default=None,
        metadata={
            "name": "FrqcyAsDSS",
            "type": "Element",
...
class LongPostalAddress1ChoiceSemt00500102(ISO20022MessageElement):
    ...
    strd: Optional[StructuredLongPostalAddress1Semt00500102] = field(
        default=None,
        metadata={
            "name": "Strd",
            "type": "Element",
...
class PriceRateOrAmountOrUnknownChoiceSemt00500102(ISO20022MessageElement):
    ...
    amt: Optional[ActiveOrHistoricCurrencyAnd13DecimalAmountSemt00500102] = field(
        default=None,
        metadata={
            "name": "Amt",
            "type": "Element",
...
class SafekeepingPlaceAsCodeAndPartyIdentificationSemt00500102(ISO20022MessageElement):
    ...
    pty: Optional[PartyIdentification3Semt00500102] = field(
        default=None,
        metadata={
            "name": "Pty",
            "type": "Element",
...
class SecurityIdentification3ChoiceSemt00500102(ISO20022MessageElement):
    ...
    othr_prtry_id: Optional[AlternateSecurityIdentification1Semt00500102] = field(
        default=None,
        metadata={
            "name": "OthrPrtryId",
            "type": "Element",
...
class StatementBasisCodeAndDsscodeChoiceSemt00500102(ISO20022MessageElement):
    ...
    stmt_bsis_as_dss: Optional[GenericIdentification7Semt00500102] = field(
        default=None,
        metadata={
            "name": "StmtBsisAsDSS",
            "type": "Element",
...
class StatementUpdateTypeCodeAndDsscodeChoiceSemt00500102(ISO20022MessageElement):
    ...
    stmt_upd_tp_as_dss: Optional[GenericIdentification7Semt00500102] = field(
        default=None,
        metadata={
            "name": "StmtUpdTpAsDSS",
            "type": "Element",
...
class TotalValueInPageAndStatementSemt00500102(ISO20022MessageElement):
    ...
    ttl_hldgs_val_of_stmt: Optional[ActiveCurrencyAndAmountSemt00500102] = field(
        default=None,
        metadata={
...
class NameAndAddress2Semt00500102(ISO20022MessageElement):
    ...
    adr: Optional[LongPostalAddress1ChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "Adr",
            "type": "Element",
...
class NameAndAddress5Semt00500102(ISO20022MessageElement):
    ...
    adr: Optional[PostalAddress1Semt00500102] = field(
        default=None,
        metadata={
            "name": "Adr",
            "type": "Element",
...
class PriceSourceFormatChoiceSemt00500102(ISO20022MessageElement):
    ...
    non_lcl_mkt_plc: Optional[PriceSourceSemt00500102] = field(
        default=None,
        metadata={
            "name": "NonLclMktPlc",
            "type": "Element",
    ...
    plc_as_dss: Optional[GenericIdentification5Semt00500102] = field(
        default=None,
        metadata={
            "name": "PlcAsDSS",
            "type": "Element",
...
class SafekeepingPlaceFormatChoiceSemt00500102(ISO20022MessageElement):
    ...
    id_as_dss: Optional[GenericIdentification5Semt00500102] = field(
        default=None,
        metadata={
            "name": "IdAsDSS",
            "type": "Element",
...
class Statement6Semt00500102(ISO20022MessageElement):
    ...
    stmt_dt_tm: Optional[DateAndDateTimeChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "StmtDtTm",
            "type": "Element",
    ...
    cre_dt_tm: Optional[DateAndDateTimeChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "CreDtTm",
            "type": "Element",
    ...
    frqcy: Optional[FrequencyCodeAndDsscode1ChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "Frqcy",
            "type": "Element",
    ...
    upd_tp: Optional[StatementUpdateTypeCodeAndDsscodeChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "UpdTp",
            "type": "Element",
    ...
    stmt_bsis: Optional[StatementBasisCodeAndDsscodeChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "StmtBsis",
            "type": "Element",
...
class SubBalanceQuantity1ChoiceSemt00500102(ISO20022MessageElement):
    ...
    qty_and_avlbty: Optional[QuantityAndAvailabilitySemt00500102] = field(
        default=None,
        metadata={
            "name": "QtyAndAvlbty",
            "type": "Element",
...
class AccountIdentificationFormatChoiceSemt00500102(ISO20022MessageElement):
    ...
    id_and_purp: Optional[AccountIdentificationAndPurposeSemt00500102] = field(
        default=None,
        metadata={
            "name": "IdAndPurp",
            "type": "Element",
    ...
    id_as_dss: Optional[AccountIdentification3Semt00500102] = field(
        default=None,
        metadata={
            "name": "IdAsDSS",
            "type": "Element",
...
class PartyIdentification1ChoiceSemt00500102(ISO20022MessageElement):
    ...
    prtry_id: Optional[GenericIdentification1Semt00500102] = field(
        default=None,
        metadata={
            "name": "PrtryId",
            "type": "Element",
    ...
    nm_and_adr: Optional[NameAndAddress2Semt00500102] = field(
        default=None,
        metadata={
            "name": "NmAndAdr",
            "type": "Element",
...
class PartyIdentification2ChoiceSemt00500102(ISO20022MessageElement):
    ...
    nm_and_adr: Optional[NameAndAddress5Semt00500102] = field(
        default=None,
        metadata={
            "name": "NmAndAdr",
            "type": "Element",
...
class PriceInformation2Semt00500102(ISO20022MessageElement):
    ...
    src_of_pric: Optional[PriceSourceFormatChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "SrcOfPric",
            "type": "Element",
    ...
    qtn_dt: Optional[DateAndDateTimeChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "QtnDt",
            "type": "Element",
...
class Account7Semt00500102(ISO20022MessageElement):
    ...
    acct_svcr: Optional[PartyIdentification2ChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "AcctSvcr",
            "type": "Element",
...
class AdditionalReference2Semt00500102(ISO20022MessageElement):
    ...
    ref_issr: Optional[PartyIdentification1ChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "RefIssr",
            "type": "Element",
...
class ForeignExchangeTerms6Semt00500102(ISO20022MessageElement):
    ...
    qtg_instn: Optional[PartyIdentification2ChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "QtgInstn",
            "type": "Element",
...
class SubBalanceInformation2Semt00500102(ISO20022MessageElement):
    ...
    addtl_bal_brkdwn_dtls: list[AdditionalBalanceInformation2Semt00500102] = field(
        default_factory=list,
        metadata={
...
class AggregateBalancePerSafekeepingPlace4Semt00500102(ISO20022MessageElement):
    ...
    hldg_val: list[ActiveOrHistoricCurrencyAndAmountSemt00500102] = field(
        default_factory=list,
        metadata={
            "name": "HldgVal",
            "type": "Element",
    ...
    prvs_hldg_val: Optional[ActiveOrHistoricCurrencyAndAmountSemt00500102] = field(
        default=None,
        metadata={
            "name": "PrvsHldgVal",
            "type": "Element",
    ...
    acrd_intrst_amt: Optional[ActiveOrHistoricCurrencyAndAmountSemt00500102] = field(
        default=None,
        metadata={
            "name": "AcrdIntrstAmt",
            "type": "Element",
    ...
    book_val: Optional[ActiveOrHistoricCurrencyAndAmountSemt00500102] = field(
        default=None,
        metadata={
            "name": "BookVal",
            "type": "Element",
    ...
    sfkpg_plc: Optional[SafekeepingPlaceFormatChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "SfkpgPlc",
            "type": "Element",
    ...
    pric_dtls: list[PriceInformation2Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "PricDtls",
            "type": "Element",
    ...
    fxdtls: Optional[ForeignExchangeTerms6Semt00500102] = field(
        default=None,
        metadata={
            "name": "FXDtls",
            "type": "Element",
    ...
    bal_brkdwn_dtls: list[SubBalanceInformation2Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "BalBrkdwnDtls",
            "type": "Element",
...
class Intermediary11Semt00500102(ISO20022MessageElement):
    ...
    acct: Optional[Account7Semt00500102] = field(
        default=None,
        metadata={
            "name": "Acct",
            "type": "Element",
...
class AggregateBalanceInformation3Semt00500102(ISO20022MessageElement):
    ...
    fin_instrm_dtls: Optional[FinancialInstrument13Semt00500102] = field(
        default=None,
        metadata={
            "name": "FinInstrmDtls",
            "type": "Element",
    ...
    bal_at_sfkpg_plc: list[AggregateBalancePerSafekeepingPlace4Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "BalAtSfkpgPlc",
            "type": "Element",
...
class SafekeepingAccount2Semt00500102(ISO20022MessageElement):
    ...
    intrmy_inf: list[Intermediary11Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "IntrmyInf",
            "type": "Element",
    ...
    acct_ownr: Optional[PartyIdentification2ChoiceSemt00500102] = field(
        default=None,
        metadata={
            "name": "AcctOwnr",
            "type": "Element",
...
class SubAccountIdentification3Semt00500102(ISO20022MessageElement):
    ...
    bal_for_sub_acct: list[AggregateBalanceInformation3Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "BalForSubAcct",
            "type": "Element",
...
class AccountingStatementOfHoldings2Semt00500102(ISO20022MessageElement):
    ...
    acct_dtls: Optional[SafekeepingAccount2Semt00500102] = field(
        default=None,
        metadata={
            "name": "AcctDtls",
            "type": "Element",
    ...
    bal_for_acct: list[AggregateBalanceInformation3Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "BalForAcct",
            "type": "Element",
    ...
    sub_acct_dtls: list[SubAccountIdentification3Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "SubAcctDtls",
            "type": "Element",
    ...
    ttl_vals: Optional[TotalValueInPageAndStatementSemt00500102] = field(
        default=None,
        metadata={
            "name": "TtlVals",
            "type": "Element",
    ...
    xtnsn: list[Extension1Semt00500102] = field(
        default_factory=list,
        metadata={
            "name": "Xtnsn",
            "type": "Element",
...
class AccountingStatementOfHoldingsCancellationV02Semt00500102(ISO20022MessageElement):
    ...
    prvs_ref: Optional[AdditionalReference2Semt00500102] = field(
        default=None,
        metadata={
            "name": "PrvsRef",
            "type": "Element",
    ...
    rltd_ref: Optional[AdditionalReference2Semt00500102] = field(
        default=None,
        metadata={
            "name": "RltdRef",
            "type": "Element",
    ...
    msg_pgntn: Optional[PaginationSemt00500102] = field(
        default=None,
        metadata={
            "name": "MsgPgntn",
            "type": "Element",
    ...
    stmt_to_be_canc: Optional[AccountingStatementOfHoldings2Semt00500102] = field(
        default=None,
        metadata={
            "name": "StmtToBeCanc",
            "type": "Element",
...
class Semt00500102(ISO20022Message):
    ...
    acctg_stmt_of_hldgs_cxl_v02: Optional[
        AccountingStatementOfHoldingsCancellationV02Semt00500102
    ] = field(
        default=None,
        metadata={
            "name": "AcctgStmtOfHldgsCxlV02",
            "type": "Element",
            "required": True,
        },
    )
