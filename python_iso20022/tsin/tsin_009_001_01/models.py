...
@dataclass
class AccountSchemeName1ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class ActiveCurrencyAndAmountTsin00900101(ISO20022MessageElement):
...
@dataclass
class BinaryFile1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class ClearingSystemIdentification2ChoiceTsin00900101(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class DateAndPlaceOfBirthTsin00900101(ISO20022MessageElement):
...
@dataclass
class FinancialIdentificationSchemeName1ChoiceTsin00900101(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class FinancingNotificationParties1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class GenericIdentification1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class GenericIdentification20Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class LegalOrganisation1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class OrganisationIdentificationSchemeName1ChoiceTsin00900101(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class PercentageAndPeriod1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class PersonIdentificationSchemeName1ChoiceTsin00900101(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class SignatureEnvelopeTsin00900101(ISO20022MessageElement):
...
@dataclass
class StrictPayloadTsin00900101(ISO20022MessageElement):
...
@dataclass
class AlgorithmAndDigest1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class AmountAndPeriod1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class ClearingSystemMemberIdentification2Tsin00900101(ISO20022MessageElement):
...
@dataclass
class ContactDetails2Tsin00900101(ISO20022MessageElement):
...
@dataclass
class Contacts3Tsin00900101(ISO20022MessageElement):
    nm_prfx: Optional[NamePrefix1Code] = field(
        default=None,
        metadata={
            "name": "NmPrfx",
...
@dataclass
class CountrySubdivision1ChoiceTsin00900101(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class GenericAccountIdentification1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericFinancialIdentification1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericOrganisationIdentification1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericPersonIdentification1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GovernanceIdentification1ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class PostalAddress1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class PostalAddress6Tsin00900101(ISO20022MessageElement):
    adr_tp: Optional[AddressType2Code] = field(
        default=None,
        metadata={
            "name": "AdrTp",
...
@dataclass
class QualifiedPartyAndXmlsignature1Tsin00900101(ISO20022MessageElement):
    class Meta:
...
@dataclass
class StatusReason4ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class TaxExemptionReasonFormatChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class TradeMarket1ChoiceTsin00900101(ISO20022MessageElement):
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class AccountIdentification4ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class BranchData2Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class FinancialInstitutionIdentification8Tsin00900101(ISO20022MessageElement):
...
@dataclass
class GuaranteeDetails1Tsin00900101(ISO20022MessageElement):
    issr: Optional[str] = field(
        default=None,
        metadata={
            "name": "Issr",
...
@dataclass
class Location1Tsin00900101(ISO20022MessageElement):
    ctry: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctry",
...
@dataclass
class NameAndAddress5Tsin00900101(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class OrganisationIdentification6Tsin00900101(ISO20022MessageElement):
...
@dataclass
class OrganisationIdentification7Tsin00900101(ISO20022MessageElement):
...
@dataclass
class PersonIdentification5Tsin00900101(ISO20022MessageElement):
...
@dataclass
class QualifiedDocumentInformation1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class TaxParty3Tsin00900101(ISO20022MessageElement):
...
@dataclass
class ValidationStatusInformation1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class BranchAndFinancialInstitutionIdentification5Tsin00900101(ISO20022MessageElement):
...
@dataclass
class FinancialItemParameters1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class GovernanceRules2Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class Party10ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class Party8ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class PartyIdentification2ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class FinancingAgreementItem1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class PartyIdentification42Tsin00900101(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification45Tsin00900101(ISO20022MessageElement):
...
@dataclass
class FinancingAgreementList1Tsin00900101(ISO20022MessageElement):
    idr: Optional[str] = field(
        default=None,
        metadata={
            "name": "Idr",
...
@dataclass
class Party9ChoiceTsin00900101(ISO20022MessageElement):
...
@dataclass
class TradeParty1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class BusinessApplicationHeader1Tsin00900101(ISO20022MessageElement):
    char_set: Optional[str] = field(
        default=None,
        metadata={
            "name": "CharSet",
...
@dataclass
class SingleQualifiedPartyIdentification1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class EncapsulatedBusinessMessage1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class QualifiedPartyIdentification1Tsin00900101(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class BusinessLetter1Tsin00900101(ISO20022MessageElement):
...
@dataclass
class PartyRegistrationAndGuaranteeRequestV01Tsin00900101(ISO20022MessageElement):
...
@dataclass
class Tsin00900101(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.009.001.01"
