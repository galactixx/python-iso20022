...
@dataclass
class DateAndPlaceOfBirthTsrv00900101:
...
@dataclass
class OrganisationIdentificationSchemeName1ChoiceTsrv00900101:
...
@dataclass
class PersonIdentificationSchemeName1ChoiceTsrv00900101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ProprietaryData3Tsrv00900101:
...
@dataclass
class ContactDetails2Tsrv00900101:
...
@dataclass
class GenericOrganisationIdentification1Tsrv00900101:
...
@dataclass
class GenericPersonIdentification1Tsrv00900101:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PostalAddress6Tsrv00900101:
...
@dataclass
class OrganisationIdentification8Tsrv00900101:
...
@dataclass
class PersonIdentification5Tsrv00900101:
...
@dataclass
class Party11ChoiceTsrv00900101:
...
@dataclass
class PartyIdentification43Tsrv00900101:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyAndSignature2Tsrv00900101:
...
@dataclass
class UndertakingAmendmentResponseMessage1Tsrv00900101:
...
@dataclass
class UndertakingAmendmentResponseNotificationV01Tsrv00900101:
