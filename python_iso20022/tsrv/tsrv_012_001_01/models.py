...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:tsrv.012.001.01"
...
class DocumentFormat1ChoiceTsrv01200101:
    ...
    prtry: Optional[GenericIdentification1Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "Prtry",
            "type": "Element",
...
class GenericOrganisationIdentification1Tsrv01200101:
    ...
    schme_nm: Optional[OrganisationIdentificationSchemeName1ChoiceTsrv01200101] = field(
        default=None,
        metadata={
            "name": "SchmeNm",
            "type": "Element",
...
class GenericPersonIdentification1Tsrv01200101:
    ...
    schme_nm: Optional[PersonIdentificationSchemeName1ChoiceTsrv01200101] = field(
        default=None,
        metadata={
            "name": "SchmeNm",
            "type": "Element",
...
class OrganisationIdentification8Tsrv01200101:
    ...
    othr: list[GenericOrganisationIdentification1Tsrv01200101] = field(
        default_factory=list,
        metadata={
            "name": "Othr",
            "type": "Element",
...
class PersonIdentification5Tsrv01200101:
    ...
    othr: list[GenericPersonIdentification1Tsrv01200101] = field(
        default_factory=list,
        metadata={
            "name": "Othr",
            "type": "Element",
...
class UndertakingTermination3Tsrv01200101:
    ...
    rsn: Optional[TerminationReason1ChoiceTsrv01200101] = field(
        default=None,
        metadata={
            "name": "Rsn",
            "type": "Element",
...
class Party11ChoiceTsrv01200101:
    ...
    prvt_id: Optional[PersonIdentification5Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "PrvtId",
            "type": "Element",
...
class PartyIdentification43Tsrv01200101:
    ...
    pstl_adr: Optional[PostalAddress6Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "PstlAdr",
            "type": "Element",
    ...
    id: Optional[Party11ChoiceTsrv01200101] = field(
        default=None,
        metadata={
            "name": "Id",
            "type": "Element",
    ...
    ctct_dtls: Optional[ContactDetails2Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "CtctDtls",
            "type": "Element",
...
class PartyAndSignature2Tsrv01200101:
    ...
    sgntr: Optional[ProprietaryData3Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "Sgntr",
            "type": "Element",
...
class Undertaking9Tsrv01200101:
    ...
    issr: Optional[PartyIdentification43Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "Issr",
            "type": "Element",
...
class Document9Tsrv01200101:
    ...
    frmt: Optional[DocumentFormat1ChoiceTsrv01200101] = field(
        default=None,
        metadata={
            "name": "Frmt",
            "type": "Element",
    ...
    dgtl_sgntr: Optional[PartyAndSignature2Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "DgtlSgntr",
            "type": "Element",
...
class UndertakingTerminationNotice1Tsrv01200101:
    ...
    termntn_dtls: Optional[UndertakingTermination3Tsrv01200101] = field(
        default=None,
        metadata={
            "name": "TermntnDtls",
            "type": "Element",
    ...
    nclsd_file: list[Document9Tsrv01200101] = field(
        default_factory=list,
        metadata={
            "name": "NclsdFile",
            "type": "Element",
...
class Tsrv01200101:
    ...
    udrtkg_termntn_ntfctn: Optional[
        UndertakingTerminationNotificationV01Tsrv01200101
    ] = field(
        default=None,
        metadata={
            "name": "UdrtkgTermntnNtfctn",
            "type": "Element",
            "required": True,
        },
    )
