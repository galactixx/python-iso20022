...
@dataclass
class ActiveCurrencyAndAmountTsrv00600101:
...
@dataclass
class AdvisingPartyAdditionalInformation1Tsrv00600101:
...
@dataclass
class AutoExtend1ChoiceTsrv00600101:
...
@dataclass
class DateAndDateTimeChoiceTsrv00600101:
    dt: Optional[XmlDate] = field(
        default=None,
        metadata={
            "name": "Dt",
...
@dataclass
class DateAndPlaceOfBirthTsrv00600101:
...
@dataclass
class GenericIdentification1Tsrv00600101:
...
@dataclass
class OrganisationIdentificationSchemeName1ChoiceTsrv00600101:
...
@dataclass
class PersonIdentificationSchemeName1ChoiceTsrv00600101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ProprietaryData3Tsrv00600101:
...
@dataclass
class Amount1ChoiceTsrv00600101:
...
@dataclass
class CommunicationMethod1ChoiceTsrv00600101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ContactDetails2Tsrv00600101:
...
@dataclass
class DocumentFormat1ChoiceTsrv00600101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class GenericOrganisationIdentification1Tsrv00600101:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericPersonIdentification1Tsrv00600101:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class NarrativeType1ChoiceTsrv00600101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class PartyType1ChoiceTsrv00600101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class PostalAddress6Tsrv00600101:
...
@dataclass
class TerminationReason1ChoiceTsrv00600101:
...
@dataclass
class UndertakingDocumentType1ChoiceTsrv00600101:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class CommunicationChannel1Tsrv00600101:
...
@dataclass
class NonExtension1Tsrv00600101:
...
@dataclass
class OrganisationIdentification8Tsrv00600101:
...
@dataclass
class PersonIdentification5Tsrv00600101:
...
@dataclass
class UndertakingAmount2Tsrv00600101:
...
@dataclass
class UndertakingTermination3Tsrv00600101:
...
@dataclass
class AutoExtension1Tsrv00600101:
...
@dataclass
class Party11ChoiceTsrv00600101:
...
@dataclass
class ExpiryTerms1Tsrv00600101:
...
@dataclass
class PartyIdentification43Tsrv00600101:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class ExpiryDetails1Tsrv00600101:
...
@dataclass
class PartyAndSignature2Tsrv00600101:
...
@dataclass
class Undertaking7Tsrv00600101:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class UndertakingConfirmation1Tsrv00600101:
...
@dataclass
class Undertaking11Tsrv00600101:
...
@dataclass
class UndertakingAmendmentMessage1Tsrv00600101:
...
@dataclass
class UndertakingAmendmentAdviceV01Tsrv00600101:
    advsg_pty: Optional[PartyIdentification43Tsrv00600101] = field(
        default=None,
        metadata={
            "name": "AdvsgPty",
