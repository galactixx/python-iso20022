...
@dataclass
class GenericIdentification30Reda02900101:
...
@dataclass
class IdentificationSource3ChoiceReda02900101:
...
@dataclass
class OriginalBusinessInstruction1Reda02900101:
...
@dataclass
class SupplementaryDataEnvelope1Reda02900101:
...
@dataclass
class MessageHeader12Reda02900101:
    msg_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "MsgId",
...
@dataclass
class OtherIdentification1Reda02900101:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ProprietaryReason4Reda02900101:
...
@dataclass
class SupplementaryData1Reda02900101:
...
@dataclass
class ProprietaryStatusAndReason6Reda02900101:
...
@dataclass
class Reason18ChoiceReda02900101:
...
@dataclass
class SecurityIdentification39Reda02900101:
...
@dataclass
class ProcessingStatus72ChoiceReda02900101:
...
@dataclass
class SecurityMaintenanceStatusAdviceV01Reda02900101:
