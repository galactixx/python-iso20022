...
@dataclass
class AccountContract2Acmt01800104:
...
@dataclass
class AccountSchemeName1ChoiceAcmt01800104:
...
@dataclass
class ActiveCurrencyAndAmountAcmt01800104:
...
@dataclass
class BankTransactionCodeStructure6Acmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ClearingSystemIdentification2ChoiceAcmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ContractDocument1Acmt01800104:
...
@dataclass
class DateAndPlaceOfBirth1Acmt01800104:
...
@dataclass
class FinancialIdentificationSchemeName1ChoiceAcmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class GenericIdentification30Acmt01800104:
...
@dataclass
class MessageIdentification1Acmt01800104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class OrganisationIdentificationSchemeName1ChoiceAcmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class OtherContact1Acmt01800104:
...
@dataclass
class PersonIdentificationSchemeName1ChoiceAcmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class ProprietaryBankTransactionCodeStructure1Acmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class SupplementaryDataEnvelope1Acmt01800104:
    any_element: Optional[object] = field(
        default=None,
        metadata={
            "type": "Wildcard",
...
@dataclass
class AddressType3ChoiceAcmt01800104:
...
@dataclass
class BankTransactionCodeStructure5Acmt01800104:
    cd: Optional[str] = field(
        default=None,
        metadata={
            "name": "Cd",
...
@dataclass
class Channel2ChoiceAcmt01800104:
...
@dataclass
class ClearingSystemMemberIdentification2Acmt01800104:
...
@dataclass
class FixedAmountOrUnlimited1ChoiceAcmt01800104:
...
@dataclass
class GenericAccountIdentification1Acmt01800104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericFinancialIdentification1Acmt01800104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericOrganisationIdentification3Acmt01800104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericPersonIdentification2Acmt01800104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class MaximumAmountByPeriod1Acmt01800104:
...
@dataclass
class SupplementaryData1Acmt01800104:
...
@dataclass
class AccountIdentification4ChoiceAcmt01800104:
...
@dataclass
class Authorisation2Acmt01800104:
...
@dataclass
class BankTransactionCodeStructure4Acmt01800104:
...
@dataclass
class OrganisationIdentification39Acmt01800104:
...
@dataclass
class PersonIdentification18Acmt01800104:
...
@dataclass
class PostalAddress27Acmt01800104:
...
@dataclass
class AccountForAction1Acmt01800104:
...
@dataclass
class FinancialInstitutionIdentification23Acmt01800104:
...
@dataclass
class Party52ChoiceAcmt01800104:
...
@dataclass
class BranchAndFinancialInstitutionIdentification8Acmt01800104:
...
@dataclass
class PartyIdentification272Acmt01800104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyAndCertificate6Acmt01800104:
...
@dataclass
class PartyAndCertificate7Acmt01800104:
...
@dataclass
class PartyAndSignature4Acmt01800104:
    pty: Optional[PartyIdentification272Acmt01800104] = field(
        default=None,
        metadata={
            "name": "Pty",
...
@dataclass
class PartyOrGroup3ChoiceAcmt01800104:
    grp_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "GrpId",
...
@dataclass
class PartyAndAuthorisation6Acmt01800104:
    mod_cd: Optional[Modification1Code] = field(
        default=None,
        metadata={
            "name": "ModCd",
...
@dataclass
class OperationMandate6Acmt01800104:
    mod_cd: Optional[Modification1Code] = field(
        default=None,
        metadata={
            "name": "ModCd",
...
@dataclass
class AccountMandateMaintenanceAmendmentRequestV04Acmt01800104:
