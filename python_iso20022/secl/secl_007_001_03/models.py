...
@dataclass
class ActiveCurrencyAndAmountSecl00700103:
...
@dataclass
class ActiveOrHistoricCurrencyAnd13DecimalAmountSecl00700103:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class ActiveOrHistoricCurrencyAndAmountSecl00700103:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class FinancialInstrumentQuantity1ChoiceSecl00700103:
...
@dataclass
class GenericIdentification20Secl00700103:
...
@dataclass
class GenericIdentification29Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification30Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification40Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class IdentificationSource3ChoiceSecl00700103:
...
@dataclass
class PartyTextInformation1Secl00700103:
...
@dataclass
class PostalAddress2Secl00700103:
...
@dataclass
class SupplementaryDataEnvelope1Secl00700103:
...
@dataclass
class DateCode3ChoiceSecl00700103:
...
@dataclass
class ForeignExchangeTerms17Secl00700103:
...
@dataclass
class GenericIdentification58Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class IdentificationType6ChoiceSecl00700103:
...
@dataclass
class NameAndAddress6Secl00700103:
...
@dataclass
class OtherIdentification1Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PartyIdentification35ChoiceSecl00700103:
...
@dataclass
class PostalAddress1Secl00700103:
...
@dataclass
class PriceRateOrAmountChoiceSecl00700103:
...
@dataclass
class SafekeepingPlaceTypeAndAnyBicidentifier1Secl00700103:
    class Meta:
...
@dataclass
class SafekeepingPlaceTypeAndText1Secl00700103:
...
@dataclass
class SecuritiesAccount18Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SecuritiesAccount19Secl00700103:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class SupplementaryData1Secl00700103:
...
@dataclass
class AlternatePartyIdentification4Secl00700103:
...
@dataclass
class AmountAndDirection27Secl00700103:
...
@dataclass
class DateFormat15ChoiceSecl00700103:
...
@dataclass
class NameAndAddress5Secl00700103:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification33ChoiceSecl00700103:
...
@dataclass
class SafekeepingPlaceFormat7ChoiceSecl00700103:
...
@dataclass
class SecurityIdentification14Secl00700103:
...
@dataclass
class PartyIdentification34ChoiceSecl00700103:
    bic: Optional[str] = field(
        default=None,
        metadata={
            "name": "BIC",
...
@dataclass
class PartyIdentificationAndAccount31Secl00700103:
...
@dataclass
class SettlementObligation7Secl00700103:
...
@dataclass
class BuyInNotificationV03Secl00700103:
