...
@dataclass
class AccountSchemeName1ChoiceSetr00100104:
...
@dataclass
class ActiveCurrencyAndAmountSetr00100104:
...
@dataclass
class ActiveOrHistoricCurrencyAndAmountSetr00100104:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class ClearingSystemMemberIdentificationChoiceSetr00100104:
...
@dataclass
class CopyInformation4Setr00100104:
...
@dataclass
class DateAndDateTimeChoiceSetr00100104:
...
@dataclass
class DateFormat42ChoiceSetr00100104:
...
@dataclass
class GenericIdentification1Setr00100104:
...
@dataclass
class GenericIdentification30Setr00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification47Setr00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class IdentificationSource1ChoiceSetr00100104:
...
@dataclass
class MessageIdentification1Setr00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PlaceOfTradeIdentification1ChoiceSetr00100104:
...
@dataclass
class AlternateSecurityIdentification7Setr00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class CancellationRight1ChoiceSetr00100104:
...
@dataclass
class ChargeBasis2ChoiceSetr00100104:
...
@dataclass
class ChargeType5ChoiceSetr00100104:
...
@dataclass
class CountryAndResidentialStatusType2Setr00100104:
    ctry: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctry",
...
@dataclass
class CustomerConductClassification1ChoiceSetr00100104:
...
@dataclass
class Equalisation1Setr00100104:
...
@dataclass
class ExemptionReason1ChoiceSetr00100104:
...
@dataclass
class FinancialInstrumentQuantity28ChoiceSetr00100104:
...
@dataclass
class FundOrderType4ChoiceSetr00100104:
...
@dataclass
class GenericAccountIdentification1Setr00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification78Setr00100104:
...
@dataclass
class InvestmentAccountType1ChoiceSetr00100104:
...
@dataclass
class InvestmentFundRole2ChoiceSetr00100104:
...
@dataclass
class OrderBreakdownType1ChoiceSetr00100104:
...
@dataclass
class OrderWaiverReason3ChoiceSetr00100104:
...
@dataclass
class OtherIdentification3ChoiceSetr00100104:
...
@dataclass
class PostalAddress1Setr00100104:
...
@dataclass
class SafekeepingPlaceTypeAndAnyBicidentifier1Setr00100104:
    class Meta:
...
@dataclass
class SafekeepingPlaceTypeAndText6Setr00100104:
...
@dataclass
class SettlementTransactionCondition30ChoiceSetr00100104:
...
@dataclass
class SignatureType1ChoiceSetr00100104:
...
@dataclass
class TaxAmountOrRate4ChoiceSetr00100104:
...
@dataclass
class TaxBasis1ChoiceSetr00100104:
...
@dataclass
class TaxType3ChoiceSetr00100104:
...
@dataclass
class TradeTransactionCondition8ChoiceSetr00100104:
...
@dataclass
class TransactionChannelType1ChoiceSetr00100104:
...
@dataclass
class WaivingInstruction2ChoiceSetr00100104:
...
@dataclass
class AccountIdentification4ChoiceSetr00100104:
...
@dataclass
class ChargeOrCommissionDiscount1Setr00100104:
    amt: Optional[ActiveCurrencyAndAmountSetr00100104] = field(
        default=None,
        metadata={
            "name": "Amt",
...
@dataclass
class GenericIdentification164Setr00100104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class InvestmentAccount60Setr00100104:
...
@dataclass
class InvestmentFundsOrderBreakdown2Setr00100104:
...
@dataclass
class NameAndAddress4Setr00100104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class NameAndAddress5Setr00100104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class OrderWaiver1Setr00100104:
...
@dataclass
class SafekeepingPlaceFormat8ChoiceSetr00100104:
...
@dataclass
class SecurityIdentification25ChoiceSetr00100104:
...
@dataclass
class TaxCalculationInformation9Setr00100104:
...
@dataclass
class AccountIdentificationAndName5Setr00100104:
...
@dataclass
class DeliveryParameters3Setr00100104:
...
@dataclass
class FinancialInstitutionIdentification8ChoiceSetr00100104:
...
@dataclass
class FinancialInstrument57Setr00100104:
...
@dataclass
class IndividualPerson32Setr00100104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification90ChoiceSetr00100104:
...
@dataclass
class FinancialInstitutionIdentification10Setr00100104:
...
@dataclass
class PartyIdentification113Setr00100104:
...
@dataclass
class AdditionalReference8Setr00100104:
...
@dataclass
class AdditionalReference9Setr00100104:
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class CreditTransfer8Setr00100104:
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class ForeignExchangeTerms32Setr00100104:
...
@dataclass
class InvestmentAccount58Setr00100104:
    acct_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "AcctId",
...
@dataclass
class PartyIdentificationAndAccount147Setr00100104:
...
@dataclass
class DeliveringPartiesAndAccount16Setr00100104:
...
@dataclass
class Intermediary40Setr00100104:
...
@dataclass
class PaymentInstrument21ChoiceSetr00100104:
...
@dataclass
class ReceivingPartiesAndAccount16Setr00100104:
...
@dataclass
class FundSettlementParameters12Setr00100104:
...
@dataclass
class PaymentTransaction72Setr00100104:
...
@dataclass
class RedemptionOrder15Setr00100104:
...
@dataclass
class RedemptionBulkOrder6Setr00100104:
...
@dataclass
class RedemptionBulkOrderV04Setr00100104:
