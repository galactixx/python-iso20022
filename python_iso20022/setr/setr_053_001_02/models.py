...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:setr.053.001.02"
...
class CancellationReason31ChoiceSetr05300102:
    ...
    prtry: Optional[GenericIdentification47Setr05300102] = field(
        default=None,
        metadata={
            "name": "Prtry",
            "type": "Element",
...
class InvestmentFundOrder11Setr05300102:
    ...
    cxl_rsn: Optional[CancellationReason31ChoiceSetr05300102] = field(
        default=None,
        metadata={
            "name": "CxlRsn",
            "type": "Element",
...
class NameAndAddress5Setr05300102:
    ...
    adr: Optional[PostalAddress1Setr05300102] = field(
        default=None,
        metadata={
            "name": "Adr",
            "type": "Element",
...
class PartyIdentification90ChoiceSetr05300102:
    ...
    prtry_id: Optional[GenericIdentification1Setr05300102] = field(
        default=None,
        metadata={
            "name": "PrtryId",
            "type": "Element",
    ...
    nm_and_adr: Optional[NameAndAddress5Setr05300102] = field(
        default=None,
        metadata={
            "name": "NmAndAdr",
            "type": "Element",
...
class AdditionalReference8Setr05300102:
    ...
    ref_issr: Optional[PartyIdentification113Setr05300102] = field(
        default=None,
        metadata={
            "name": "RefIssr",
            "type": "Element",
...
class RedemptionBulkOrderConfirmationCancellationInstructionV02Setr05300102:
    ...
    pool_ref: Optional[AdditionalReference9Setr05300102] = field(
        default=None,
        metadata={
            "name": "PoolRef",
            "type": "Element",
    ...
    prvs_ref: list[AdditionalReference8Setr05300102] = field(
        default_factory=list,
        metadata={
            "name": "PrvsRef",
            "type": "Element",
    ...
    rltd_ref: Optional[AdditionalReference8Setr05300102] = field(
        default=None,
        metadata={
            "name": "RltdRef",
            "type": "Element",
    ...
    ordr_refs: list[InvestmentFundOrder11Setr05300102] = field(
        default_factory=list,
        metadata={
            "name": "OrdrRefs",
            "type": "Element",
    ...
    cpy_dtls: Optional[CopyInformation4Setr05300102] = field(
        default=None,
        metadata={
            "name": "CpyDtls",
            "type": "Element",
...
class Setr05300102:
    ...
    red_blk_ordr_conf_cxl_instr: Optional[
        RedemptionBulkOrderConfirmationCancellationInstructionV02Setr05300102
    ] = field(
        default=None,
        metadata={
            "name": "RedBlkOrdrConfCxlInstr",
            "type": "Element",
            "required": True,
        },
    )
