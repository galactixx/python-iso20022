...
@dataclass
class CopyInformation4Setr05500102:
...
@dataclass
class GenericIdentification1Setr05500102:
...
@dataclass
class GenericIdentification47Setr05500102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class MessageIdentification1Setr05500102:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class CancellationReason31ChoiceSetr05500102:
...
@dataclass
class PostalAddress1Setr05500102:
...
@dataclass
class InvestmentFundOrder11Setr05500102:
...
@dataclass
class NameAndAddress5Setr05500102:
...
@dataclass
class PartyIdentification90ChoiceSetr05500102:
...
@dataclass
class PartyIdentification113Setr05500102:
...
@dataclass
class AdditionalReference8Setr05500102:
...
@dataclass
class AdditionalReference9Setr05500102:
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
