...
@dataclass
class AccountSchemeName1ChoiceSetr00900104:
...
@dataclass
class ActiveCurrencyAnd13DecimalAmountSetr00900104:
...
@dataclass
class ActiveCurrencyAndAmountSetr00900104:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class ActiveOrHistoricCurrencyAndAmountSetr00900104:
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class ClearingSystemMemberIdentificationChoiceSetr00900104:
...
@dataclass
class CopyInformation4Setr00900104:
...
@dataclass
class DateAndDateTimeChoiceSetr00900104:
...
@dataclass
class DateFormat42ChoiceSetr00900104:
...
@dataclass
class GenericIdentification1Setr00900104:
...
@dataclass
class GenericIdentification30Setr00900104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification47Setr00900104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class IdentificationSource1ChoiceSetr00900104:
...
@dataclass
class MessageIdentification1Setr00900104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PlaceOfTradeIdentification1ChoiceSetr00900104:
...
@dataclass
class AlternateSecurityIdentification7Setr00900104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class CancellationRight1ChoiceSetr00900104:
...
@dataclass
class ChargeBasis2ChoiceSetr00900104:
...
@dataclass
class ChargeType5ChoiceSetr00900104:
...
@dataclass
class CountryAndResidentialStatusType2Setr00900104:
    ctry: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctry",
...
@dataclass
class CustomerConductClassification1ChoiceSetr00900104:
...
@dataclass
class EucapitalGain3ChoiceSetr00900104:
    class Meta:
...
@dataclass
class EudividendStatusType2ChoiceSetr00900104:
    class Meta:
...
@dataclass
class Equalisation1Setr00900104:
...
@dataclass
class ExemptionReason1ChoiceSetr00900104:
...
@dataclass
class FundOrderType4ChoiceSetr00900104:
...
@dataclass
class GenericAccountIdentification1Setr00900104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification78Setr00900104:
...
@dataclass
class InvestmentAccountType1ChoiceSetr00900104:
...
@dataclass
class InvestmentFundRole2ChoiceSetr00900104:
...
@dataclass
class OrderBreakdownType1ChoiceSetr00900104:
...
@dataclass
class OrderWaiverReason3ChoiceSetr00900104:
...
@dataclass
class OtherIdentification3ChoiceSetr00900104:
...
@dataclass
class PostalAddress1Setr00900104:
...
@dataclass
class ProfitAndLoss2ChoiceSetr00900104:
...
@dataclass
class SafekeepingPlaceTypeAndAnyBicidentifier1Setr00900104:
    class Meta:
...
@dataclass
class SafekeepingPlaceTypeAndText6Setr00900104:
...
@dataclass
class SettlementTransactionCondition30ChoiceSetr00900104:
...
@dataclass
class SignatureType1ChoiceSetr00900104:
...
@dataclass
class SourceOfCash1ChoiceSetr00900104:
...
@dataclass
class TaxBasis1ChoiceSetr00900104:
...
@dataclass
class TaxType3ChoiceSetr00900104:
...
@dataclass
class TaxableIncomePerShareCalculated2ChoiceSetr00900104:
...
@dataclass
class TradeTransactionCondition8ChoiceSetr00900104:
...
@dataclass
class TransactionChannelType1ChoiceSetr00900104:
...
@dataclass
class TypeOfPrice46ChoiceSetr00900104:
...
@dataclass
class WaivingInstruction2ChoiceSetr00900104:
...
@dataclass
class AccountIdentification4ChoiceSetr00900104:
...
@dataclass
class ChargeOrCommissionDiscount1Setr00900104:
...
@dataclass
class GenericIdentification164Setr00900104:
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class InvestmentAccount60Setr00900104:
...
@dataclass
class InvestmentFundsOrderBreakdown2Setr00900104:
...
@dataclass
class NameAndAddress4Setr00900104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class NameAndAddress5Setr00900104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class OrderWaiver1Setr00900104:
...
@dataclass
class SafekeepingPlaceFormat8ChoiceSetr00900104:
...
@dataclass
class SecurityIdentification25ChoiceSetr00900104:
...
@dataclass
class TaxCalculationInformation10Setr00900104:
...
@dataclass
class AccountIdentificationAndName5Setr00900104:
...
@dataclass
class DeliveryParameters3Setr00900104:
...
@dataclass
class FinancialInstitutionIdentification8ChoiceSetr00900104:
...
@dataclass
class FinancialInstrument57Setr00900104:
...
@dataclass
class IndividualPerson31Setr00900104:
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification90ChoiceSetr00900104:
...
@dataclass
class FinancialInstitutionIdentification10Setr00900104:
...
@dataclass
class PartyIdentification113Setr00900104:
...
@dataclass
class AdditionalReference8Setr00900104:
...
@dataclass
class AdditionalReference9Setr00900104:
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class CreditTransfer8Setr00900104:
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class DirectDebitMandate6Setr00900104:
    dbtr_acct: Optional[AccountIdentificationAndName5Setr00900104] = field(
        default=None,
        metadata={
            "name": "DbtrAcct",
...
@dataclass
class ForeignExchangeTerms33Setr00900104:
...
@dataclass
class InvestmentAccount58Setr00900104:
    acct_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "AcctId",
...
@dataclass
class PartyIdentificationAndAccount147Setr00900104:
...
@dataclass
class PaymentCard25Setr00900104:
...
@dataclass
class DeliveringPartiesAndAccount16Setr00900104:
...
@dataclass
class InformativeTax1Setr00900104:
...
@dataclass
class Intermediary39Setr00900104:
...
@dataclass
class PaymentInstrument20ChoiceSetr00900104:
...
@dataclass
class ReceivingPartiesAndAccount16Setr00900104:
...
@dataclass
class TotalFeesAndTaxes40Setr00900104:
...
@dataclass
class FundSettlementParameters12Setr00900104:
...
@dataclass
class PaymentTransaction70Setr00900104:
...
@dataclass
class SubscriptionExecution12Setr00900104:
...
@dataclass
class SubscriptionBulkExecution4Setr00900104:
...
@dataclass
class SubscriptionBulkOrderConfirmationV04Setr00900104:
