...
@dataclass
class AccountSchemeName1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class ActiveCurrencyAndAmountSetr01000104(ISO20022MessageElement):
...
@dataclass
class ActiveOrHistoricCurrencyAndAmountSetr01000104(ISO20022MessageElement):
    value: Optional[Decimal] = field(
        default=None,
        metadata={
            "required": True,
...
@dataclass
class ClearingSystemMemberIdentificationChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class CopyInformation4Setr01000104(ISO20022MessageElement):
...
@dataclass
class DateAndDateTimeChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class DateFormat42ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class Extension1Setr01000104(ISO20022MessageElement):
...
@dataclass
class GenericIdentification1Setr01000104(ISO20022MessageElement):
...
@dataclass
class GenericIdentification30Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification47Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class IdentificationSource1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class MessageIdentification1Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class PlaceOfTradeIdentification1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class SubAccount6Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class AlternateSecurityIdentification7Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class CancellationRight1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class ChargeBasis2ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class ChargeType5ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class CountryAndResidentialStatusType2Setr01000104(ISO20022MessageElement):
    ctry: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ctry",
...
@dataclass
class CustomerConductClassification1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class Equalisation1Setr01000104(ISO20022MessageElement):
...
@dataclass
class ExemptionReason1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class FinancialInstrumentQuantity27ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class FundOrderType4ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class GenericAccountIdentification1Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class GenericIdentification78Setr01000104(ISO20022MessageElement):
...
@dataclass
class InvestmentAccountType1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class InvestmentFundRole2ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class OrderBreakdownType1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class OrderWaiverReason3ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class OtherIdentification3ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class PostalAddress1Setr01000104(ISO20022MessageElement):
...
@dataclass
class SafekeepingPlaceTypeAndAnyBicidentifier1Setr01000104(ISO20022MessageElement):
    class Meta:
...
@dataclass
class SafekeepingPlaceTypeAndText6Setr01000104(ISO20022MessageElement):
...
@dataclass
class Series1Setr01000104(ISO20022MessageElement):
...
@dataclass
class SettlementTransactionCondition30ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class SignatureType1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class SourceOfCash1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class TaxAmountOrRate4ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class TaxBasis1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class TaxType3ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class TradeTransactionCondition8ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class TransactionChannelType1ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class WaivingInstruction2ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class AccountIdentification4ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class BranchDataSetr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class ChargeOrCommissionDiscount1Setr01000104(ISO20022MessageElement):
    amt: Optional[ActiveCurrencyAndAmountSetr01000104] = field(
        default=None,
        metadata={
            "name": "Amt",
...
@dataclass
class GenericIdentification164Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class InvestmentAccount60Setr01000104(ISO20022MessageElement):
...
@dataclass
class InvestmentFundsOrderBreakdown2Setr01000104(ISO20022MessageElement):
...
@dataclass
class NameAndAddress4Setr01000104(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class NameAndAddress5Setr01000104(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class OrderWaiver1Setr01000104(ISO20022MessageElement):
...
@dataclass
class SafekeepingPlaceFormat8ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class SecurityIdentification25ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class TaxCalculationInformation9Setr01000104(ISO20022MessageElement):
...
@dataclass
class AccountIdentificationAndName5Setr01000104(ISO20022MessageElement):
...
@dataclass
class FinancialInstitutionIdentification8ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class FinancialInstrument57Setr01000104(ISO20022MessageElement):
...
@dataclass
class IndividualPerson31Setr01000104(ISO20022MessageElement):
    nm: Optional[str] = field(
        default=None,
        metadata={
            "name": "Nm",
...
@dataclass
class PartyIdentification90ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class FinancialInstitutionIdentification10Setr01000104(ISO20022MessageElement):
...
@dataclass
class PartyIdentification113Setr01000104(ISO20022MessageElement):
...
@dataclass
class Account22Setr01000104(ISO20022MessageElement):
    id: Optional[str] = field(
        default=None,
        metadata={
            "name": "Id",
...
@dataclass
class AdditionalReference8Setr01000104(ISO20022MessageElement):
...
@dataclass
class AdditionalReference9Setr01000104(ISO20022MessageElement):
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class Cheque9Setr01000104(ISO20022MessageElement):
...
@dataclass
class CreditTransfer8Setr01000104(ISO20022MessageElement):
    ref: Optional[str] = field(
        default=None,
        metadata={
            "name": "Ref",
...
@dataclass
class DirectDebitMandate6Setr01000104(ISO20022MessageElement):
    dbtr_acct: Optional[AccountIdentificationAndName5Setr01000104] = field(
        default=None,
        metadata={
            "name": "DbtrAcct",
...
@dataclass
class Fee1Setr01000104(ISO20022MessageElement):
...
@dataclass
class ForeignExchangeTerms32Setr01000104(ISO20022MessageElement):
...
@dataclass
class InvestmentAccount58Setr01000104(ISO20022MessageElement):
    acct_id: Optional[str] = field(
        default=None,
        metadata={
            "name": "AcctId",
...
@dataclass
class PartyIdentificationAndAccount147Setr01000104(ISO20022MessageElement):
...
@dataclass
class PaymentCard25Setr01000104(ISO20022MessageElement):
...
@dataclass
class Tax30Setr01000104(ISO20022MessageElement):
...
@dataclass
class DeliveringPartiesAndAccount16Setr01000104(ISO20022MessageElement):
...
@dataclass
class FeeAndTax1Setr01000104(ISO20022MessageElement):
...
@dataclass
class Intermediary40Setr01000104(ISO20022MessageElement):
...
@dataclass
class PaymentInstrument20ChoiceSetr01000104(ISO20022MessageElement):
...
@dataclass
class ReceivingPartiesAndAccount16Setr01000104(ISO20022MessageElement):
...
@dataclass
class FundSettlementParameters11Setr01000104(ISO20022MessageElement):
...
@dataclass
class PaymentTransaction70Setr01000104(ISO20022MessageElement):
...
@dataclass
class SubscriptionOrder14Setr01000104(ISO20022MessageElement):
...
@dataclass
class SubscriptionMultipleOrder6Setr01000104(ISO20022MessageElement):
...
@dataclass
class SubscriptionOrderV04Setr01000104(ISO20022MessageElement):
...
@dataclass
class Setr01000104(ISO20022Message):
    class Meta:
        namespace = "urn:iso:std:iso:20022:tech:xsd:setr.010.001.04"
